...
## Overview
Cuantieval is a peer-rating app for evaluating student-created materials (tripticos/infografias) about psychological instruments. Students rate each item on 5 dimensions using a 4-point scale.
...
- **completedCount:** Number of materials rated (0–N)
- **completed:** `true/false` — whether all items are done
...
cuantieval/
  ...
  items.json          Manifest of items (auto-generated by convert.sh)
